            ...
            <div className="p-4 sm:p-5">
                <div className="flex justify-between gap-3">
                    <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[8px] text-slate-500 mt-1">123 Asokoro, Abuja</p>
                        <p className="text-[8px] text-slate-500">hello@example.com</p>
                    </div>
                    <div className="text-right shrink-0">
                        <p className="text-lg font-bold text-slate-900 leading-none">INVOICE</p>
                ...
                <div className="mt-3 grid grid-cols-2 gap-2">
                    <div className="rounded-md p-2" style={{ backgroundColor: `${BRAND}14` }}>
                        ...
                        <p className="text-[7px] text-slate-500 mt-1">hello@example.com</p>
                    </div>
                    <div className="rounded-md p-2" style={{ backgroundColor: `${BRAND}14` }}>
                        <p className="text-[7px] font-bold uppercase tracking-wide" style={{ color: BRAND }}>
                            Bill to
                        </p>
                        <p className="text-[8px] font-bold text-slate-800 mt-1">Shopperpoint</p>
                    </div>
                </div>
                ...
                <div className="mt-2 grid grid-cols-2 gap-2">
                    <div className="rounded border border-slate-100 p-1.5">
                        ...
                        <p className="text-[6px] text-slate-500 mt-0.5">GTBank · 0123456789</p>
                    </div>
                    <div className="rounded border border-slate-100 p-1.5">
                        <p className="text-[6px] font-bold uppercase" style={{ color: BRAND }}>
                            Notes
                        </p>
                        <p className="text-[6px] text-slate-500 mt-0.5">Thank you!</p>
                    </div>
                </div>
            </div>
        </div>
