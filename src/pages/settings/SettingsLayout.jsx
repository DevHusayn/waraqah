...
export function SettingsEditingStatus() {
    return (
        <span className="inline-flex items-center gap-2 text-sm font-medium text-amber-800 bg-amber-50 border border-amber-200 px-3 py-2 rounded-xl dark:bg-amber-950/50 dark:text-amber-300 dark:border-amber-800/60">
